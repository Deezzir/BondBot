...
X_REVIEW_SECOND_DELAY_SECONDS = 60 * 60  # 1 hour

X_VIEWS_THRESHOLD_POST = int(getenv("X_VIEWS_THRESHOLD_POST", "30000"))
X_VIEWS_THRESHOLD_RECHECK = int(getenv("X_VIEWS_THRESHOLD_RECHECK", "7000"))
